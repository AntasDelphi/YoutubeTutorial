...
type
  TFUtama = class(TForm)
    ...
    Label1: TLabel;
    Label2: TLabel;
    bitBatal: TCornerButton;
    BitClose: TCornerButton;
...
begin
loCLose.BringToFront;
loCLose.Visible:=True;
...
procedure TFUtama.bitBatalClick(Sender: TObject);
begin
FloatAnimation1.Start;
end;

procedure TFUtama.FloatAnimation1Finish(Sender: TObject);
begin
FloatAnimation1.Inverse:=not FloatAnimation1.Inverse;
if FloatAnimation1.Inverse=False then
loCLose.Visible:=False;
end;
...
procedure TFUtama.BitCloseClick(Sender: TObject);
begin
